...
public class UserEntity {
   ...
   */
  public UserEntity(int id, String name, String email, Path avatar, String passwordHash,
   ...
   * @param settingsEntity Instance of user SettingsEntity.
   */
  public UserEntity(int id, String name, String email, String avatar, String passwordHash,
      SettingsEntity settingsEntity) {
